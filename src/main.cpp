...
void checarParedes(){
    shortMove = true;
    A_wall = true; B_wall = true; C_wall = true; D_wall = true;
...
void resolverLaberinto(){
    if(ContadorLaberinto < 3) {   // el numero define el numero de cuadros que avanza antes de hacer pathfinding
        ...
        if(Preferencia == IZQUIERDA)
        {
            if(!D_wall) {
                ...
                moverCuadro();
                checarLasts();
            }else if(getSharpCorta(SHARP_D1) > 15)
            {
                ContadorLaberinto++;
                switch(iOrientacion) {
                    case A_NORTE:
                ...
                moverCuadro();
                checarLasts();
            }else if(getSharpCorta(SHARP_A) > 15)
            {
                ContadorLaberinto++;
                switch(iOrientacion) {
                    case A_NORTE:
                ...
                moverCuadro();
                checarLasts();
            }else if(getSharpCorta(SHARP_B1) > 15)
            {
                ContadorLaberinto++;
                switch(iOrientacion) {
                    case A_NORTE:
        ...
        if(Preferencia == DERECHA)
        {
            if(!B_wall) {
                ...
                ContadorLaberinto = 0;
                    ...
                    moverCuadro();
                    checarLasts();
                }else if(getSharpCorta(SHARP_D1)){
                    ContadorLaberinto++;
                    switch(iOrientacion) {
                        case A_NORTE:
                        y_actual--;
